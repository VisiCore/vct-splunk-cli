"""Saved-search dispatch. Click-free.

Saved-search CRUD rides the generic :mod:`vct_splunk.api.endpoint_factory` engine (see
...
:func:`vct_splunk.utils.namespace.resolve_ns`, which keeps writes out of the
default ``search`` app).
"""
